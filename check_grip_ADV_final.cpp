...
/*----------------------------------   */
   //Blocks
   #define redhuehigh 10
   #define redhuelow 0
   #define cyanhuehigh 102
   #define cyanhuelow 65
   #define yellowhuehigh 35
   #define yellowhuelow 21
   #define magnetahuehigh 174
   #define magnetahuelow 160
   #define fronthuehigh 102
   #define fronthuelow 70
   #define backhuehigh 16
   #define backhuelow 0
   
   //saturation
    #define redsathigh 256
    #define redsatlow 161
    #define yellowsathigh 146
    #define yellowsatlow 91
    #define cyansathigh 195
    #define cyansatlow 93
    #define magnetasathigh 210
    #define magnetasatlow 146
    #define backsathigh  256
    #define backsatlow  205
    #define frontsathigh 249
    #define frontsatlow 0
    
    #define redvarhigh 177
    #define redvarlow 0
    #define yellowvarhigh 256
    #define yellowvarlow 135
    #define cyanvarhigh 256
    #define cyanvarlow 117
    #define magnetavarhigh 256
    #define magnetavarlow 137
    #define backvarhigh 255
    #define backvarlow 0
    #define frontvarhigh 256
    #define frontvarlow 198
    ...
    #define depminx 60
    #define depminy 0
    #define puzzlemaxx 550
    #define puzzlemaxy 90
    #define puzzleminx 470
    #define puzzleminy 0
...
float find_Distance(float x1,float y1)
{
          float d=sqrt((x1-puzzleminx)*(x1-puzzleminx)+(y1-puzzleminy)*(y1-puzzleminy));
          return d;
}
