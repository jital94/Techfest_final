...
/*----------------------------------   */
   ...
   //saturation
    #define redsathigh 193
    #define redsatlow 121
    #define yellowsathigh 255
    #define yellowsatlow 0
    #define cyansathigh 189
    #define cyansatlow 151
...
void blobs_arena(IplImage* filter,char ch)  
{
    ...
    x=0;
    y=0;
    liftbox.centroid.x=0;
    liftbox.centroid.y=0;
...
int main()
{
    ...
    cvDestroyAllWindows();
     ...
     for(int l=0;l<num_boxes;l++)
     {
            ...
            check=calculate();
            check_boundary();
            cout<<"\ncentre check Centroid.x "<<liftbox.centroid.x<<"\t centroid.y "<<liftbox.centroid.y<<"\tcolor "<<liftbox.color<<"   distance  "<<liftbox.distance;
            cvWaitKey(0);
