...
/*----------------------------------   */
   ...
   //saturation
    ...
    #define depminx 532
    #define depminy 17
    #define puzzlemaxx 71
    #define puzzlemaxy 90
    #define puzzleminx 6
    #define puzzleminy 0
    #define intermediatex 440
    #define intermediatey 40
...
void sort_distance()
{
        ...
        for(int i=0;i<num_boxes-1;i++)
        {
                ...
                {
                        if(abs(puzzle[pos].distance-puzzle[j].distance)>12)
                             if(puzzle[pos].distance>puzzle[j].distance)
                              pos=j;
                        else if(puzzle[pos].centroid.y<puzzle[j].centroid.y)
                             pos=j;
                }
                temp=puzzle[pos];
                puzzle[pos]=puzzle[i];
